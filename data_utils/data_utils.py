...
class Sentence(object):
    ...
    def _repr_html_(self,portid, whether_visualize):
        ents = []
        ...
        if whether_visualize:
            ...
            industry_list = []
            for i in ents:
                industry_list.append(self.text[i['start']:i['end']])
...
class Document(object):
    ...
    def _repr_html_(self,portid, whether_visualize):
        ...
        return sent._repr_html_(portid, whether_visualize)
...
class Documents(object):
    ...
    def scan_doc_ids(self): # 获得数据文件的名称
        doc_ids = [fname.split('.')[0] for fname in os.listdir(self.data_dir)]
        # ['0' '1' '10' '11' '12' '123_1' '123_10' '123_11' '123_12' '123_14'
        #  '123_15' '123_17' '123_2' '123_21' '123_23' '123_24' '123_26' '123_3_1'
        #  '123_5' '123_7' '123_8' '124_12' '124_14' '124_15' '124_17' '124_27'
        #  '124_5' '124_6' '124_7' '124_8' '125_13' '125_6' '126_1' '126_20'
        #  '126_24' '126_3' '126_6' '126_8' '13' '131_1' '131_10' '131_11' '131_12'
        #  '131_14' '131_15' '131_16' '131_19' '131_2' '131_21' '131_22' '131_23'
        #  '131_24' '131_25' '131_3' '131_5' '131_6' '132_1' '132_10' '132_13'
        #  '132_14' '132_17' '132_18' '132_19' '132_2' '132_20' '132_21' '132_22'
        #  '132_23' '132_4' '132_6' '132_8' '132_9' '133_1' '133_10' '133_11'
        #  '133_13' '133_14' '133_17' '133_18' '133_19' '133_21' '133_22' '133_3'
        #  '133_9' '134_12' '134_14' '134_15' '134_16' '134_17' '134_19' '134_2'
        #  '134_20' '134_23' '134_3' '134_4' '134_5' '134_6' '134_7' '134_8' '134_9']
    ...
    def parse_entity_line(self, raw_str):
        ...
        pos = pos.split(' ')
        ent = Entity(ent_id, category, int(pos[0]), int(pos[-1]), text) # 每一个字符都被五元组完全描述
        return ent
